...
function uni_coworking_theme_filter_demo_header_list() {
	echo '<li id="theme-version"><span>Coworking Co. WP Theme 1.1.4</span></li>';
}
...
function uni_coworking_theme_styles() {
	...
	if ( ! ot_get_option( 'uni_google_fonts' ) || empty( $ot_set_google_fonts ) ) {
		wp_enqueue_style( 'uni-coworking-theme-fonts', uni_coworking_theme_fonts_url(), array(), '1.1.4' );
	}
	...
	wp_enqueue_style( 'uni-coworking-theme-adaptive', get_template_directory_uri() . '/css/adaptive.css', array( 'uni-coworking-theme-styles' ), '1.1.4', 'screen' );
}
...
function uni_coworking_theme_admin_script( $hook ) {
	...
	wp_enqueue_script( 'uni-coworking-theme-admin', get_template_directory_uri() . '/js/uni-admin.js', array( 'jquery' ), '1.1.4' );
            ...
            <div class="uni-ec-form-content">
                ...
                <div class="uni-ec-form-section uni-ec-form-section-with-btn centered uni-ec-form-section-modal">
                    <a href="<%= calEvent.meta.event_page_uri %>" class="btn btn-inform"
                       target="_blank"><?php esc_html_e( 'The event page', 'uni-calendar' ) ?></a>
                    <button class="js-uni-event-modal-close-btn btn"
                            type="button"><?php esc_html_e( 'Close', 'uni-calendar' ) ?></button>
                </div>
